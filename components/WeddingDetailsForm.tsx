...
const WeddingDetailsForm: React.FC<WeddingDetailsFormProps> = ({ initialDetails }) => {
  ...
  const formFields: Array<{
    ...
    { label: 'Groom Father Title', fieldName: 'groom_father_title_en', labelEnMs: true, required: false },
    { label: 'Groom Father Title', fieldName: 'groom_father_title_ms', labelEnMs: true, required: false },
    { label: 'Groom Mother Name', fieldName: 'groom_mother_name', required: false },
    { label: 'Groom Mother Title', fieldName: 'groom_mother_title_en', labelEnMs: true, required: false },
    { label: 'Groom Mother Title', fieldName: 'groom_mother_title_ms', labelEnMs: true, required: false },
    { label: 'Bride Father Name', fieldName: 'bride_father_name', required: false },
    { label: 'Bride Father Title', fieldName: 'bride_father_title_en', labelEnMs: true, required: false },
    { label: 'Bride Father Title', fieldName: 'bride_father_title_ms', labelEnMs: true, required: false },
    { label: 'Bride Mother Name', fieldName: 'bride_mother_name', required: false },
    { label: 'Bride Mother Title', fieldName: 'bride_mother_title_en', labelEnMs: true, required: false },
    { label: 'Bride Mother Title', fieldName: 'bride_mother_title_ms', labelEnMs: true, required: false },
