                  ...
                  <div className="text-center text-white max-w-md mx-auto px-4">
                    ...
                    <div className="mb-6 md:mb-8">
                      {isLoadingData ? (
                        ...
                        <>
                          <h1 className="text-4xl md:text-5xl font-script mb-2 text-green-100 leading-tight">
                            {weddingData?.groom_name || t.defaultGroomName}
                          </h1>
                          <div className="text-2xl md:text-3xl mb-2 opacity-80 font-script">&</div>
                          <h1 className="text-4xl md:text-5xl font-script text-green-100 leading-tight">
